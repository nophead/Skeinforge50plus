...
def getCraftSequence():
	...
	return 'carve scale bottom preface inset fill multiply speed temperature raft skirt chamber tower jitter clip skin comb cool hop dimension alteration export'.split()
